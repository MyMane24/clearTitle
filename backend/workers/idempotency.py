"""Idempotency decorator — moved from `backend.pipeline.idempotency`."""
...
from backend.domain.state_machine import Stage, already_past, stage_from_status
from backend.integrations.redis.state_store import append_log
from backend.logger import get_logger
from backend.shared.constants import STATUS_CLASSIFICATION_FAILED, STATUS_FAILED
