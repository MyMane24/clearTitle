"""
Shared helper functions for the document processing pipeline.
Moved here to eliminate circular imports between V1 and V2 tasks.
"""
...
def structure_document(merged: dict, doc_type: str) -> dict:
    ...
    from backend.services.model_router import resolve_model, get_fallback_chain
    from backend.services.rate_limiter import gemini_limiter, groq_limiter
